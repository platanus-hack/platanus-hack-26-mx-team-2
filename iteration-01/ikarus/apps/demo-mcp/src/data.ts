/**
 * Demo inbox for the standalone demo MCP service. The third message carries a
 * hidden prompt injection. Through Ikarus this content can only ever be parsed
 * as untrusted data — it can never become an action.
 */
